...
[guess, height] = algorithim(s0,s1,s2,s3,signal0,signal1,signal2,signal3,grid,speed_of_sound)
...
function [predict, amp] = algorithim(s0,s1,s2,s3,signal_0,signal_1,signal_2,signal_3,grid,speed)
