...
function [predict, amp] = algorithm(s0,s1,s2,s3,signal_0,signal_1,signal_2,signal_3,grid,speed,deviation1,average1)
    ...
    signal_0 = lowpass(signal_0,20,1024);
    signal_1 = lowpass(signal_1,20,1024);
    signal_2 = lowpass(signal_2,20,1024);
    signal_3 = lowpass(signal_3,20,1024);
    ...
    % Calculate probability of signal detection
        T_score_of_detection = (snr_count - average1)/(deviation1)
