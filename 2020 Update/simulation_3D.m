  ...
  % Iterate through all grid points
    for i = 1:329
        for k = 1:329
            ...
            signal1_shift = circshift(signal1,round(-shift_1*1024/3));
            signal2_shift = circshift(signal2,round(-shift_2*1024/3));
            signal3_shift = circshift(signal3,round(-shift_3*1024/3));
